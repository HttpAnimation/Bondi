...
```bash
git clone https://github.com/HttpAnimation/Bondi.git && cd Bondi && rm -r V1 V2 V3 More "Java port" "Steam Art" README.md && cd V4 && chmod +x Install.sh && ./Install.sh && ./Run.sh
```
