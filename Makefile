#############################################################################
# Makefile for building: Bondi.app/Contents/MacOS/Bondi
# Generated by qmake (3.1) (Qt 6.6.2)
# Project:  Bondi.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile Bondi.pro
#############################################################################
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12.0 -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12.0 -Wall -Wextra -fPIC $(DEFINES)
...
COMPRESS      = gzip -9f
DISTNAME      = Bondi1.0.0
DISTDIR = /Users/httpanimations/Desktop/Bondi/.tmp/Bondi1.0.0
LINK          = /Library/Developer/CommandLineTools/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
...
QMAKE_TARGET  = Bondi
DESTDIR       = 
TARGET        = Bondi.app/Contents/MacOS/Bondi
...
EXPORT__PRO_FILE_ = /Users/httpanimations/Desktop/Bondi/Bondi.pro
...
Bondi.app/Contents/MacOS/Bondi:  $(OBJECTS)  
	@test -d Bondi.app/Contents/MacOS/ || mkdir -p Bondi.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Bondi.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/macx.conf \
...
Bondi.app/Contents/PkgInfo: 
	@test -d Bondi.app/Contents || mkdir -p Bondi.app/Contents
	@$(DEL_FILE) Bondi.app/Contents/PkgInfo
	@echo "APPL????" > Bondi.app/Contents/PkgInfo
Bondi.app/Contents/Info.plist: 
	@test -d Bondi.app/Contents || mkdir -p Bondi.app/Contents
	@$(DEL_FILE) Bondi.app/Contents/Info.plist
	@plutil -convert xml1 -o - /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Bondi,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Bondi,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Bondi,g" -e "s,@LIBRARY@,Bondi,g" -e "s,\$${EXECUTABLE_NAME},Bondi,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Bondi.app/Contents/Info.plist

all: Makefile \
		Bondi.app/Contents/PkgInfo \
		Bondi.app/Contents/Info.plist Bondi.app/Contents/MacOS/Bondi
...
distdir: FORCE
	...
	$(COPY_FILE) --parents bondiQT.c $(DISTDIR)/
...
moc_predefs.h: /usr/local/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12.0 -Wall -Wextra -fPIC -dM -E -o moc_predefs.h /usr/local/share/qt/mkspecs/features/data/dummy.cpp
...
bondiQT.o: bondiQT.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o bondiQT.o bondiQT.c
